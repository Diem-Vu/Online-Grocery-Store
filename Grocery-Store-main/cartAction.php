...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){
        ...
        // Get product details
        //$query = $db->query("SELECT * FROM snacks, vegetable, fruits, meat, beverages, dairy WHERE id = ".$productID) or die ($db->error);
        
        $query = $db->query("SELECT * FROM productItems WHERE id = '$productID'") or die ($db->error);
        ...
        $redirectLoc = $insertItem?'viewCart.php':'index.html';
